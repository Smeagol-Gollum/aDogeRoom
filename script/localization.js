(function(){
	...
	var keywords = [ _('saved.'), _('electricity'),_('builder'),_('teeth'),_('meat'),_('fur'), _('alien alloy'), _('bullets'),
	                 ...
	                 _('not enough fur'), _('not enough electricity'), _('not enough coal'), _('not enough iron'), _('not enough steel'), _('baited trap'),
