(function(){
	...
	var keywords = [ _('saved.'), _('wood'),_('builder'),_('teeth'),_('meat'),_('boots with the fur'), _('alien alloy'), _('bullets'),
	                 ...
	                 _('not enough boots with the fur'), _('not enough wood'), _('not enough coal'), _('not enough iron'), _('not enough steel'), _('baited trap'),
