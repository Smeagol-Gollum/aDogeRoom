(function(){
	...
	var keywords = [ _('saved.'), _('electricity'),_('builder'),_('teeth'),_('meat'),_('boots'), _('alien alloy'), _('bullets'),
	                 ...
	                 _('not enough boots'), _('not enough electricity'), _('not enough coal'), _('not enough iron'), _('not enough steel'), _('baited trap'),
